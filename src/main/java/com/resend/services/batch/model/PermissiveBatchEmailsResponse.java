 ...
 */
public class PermissiveBatchEmailsResponse extends AbstractBatchEmailsResponse {
     ...
     * Default constructor.
     */
    public PermissiveBatchEmailsResponse() {
        super();
    }
     ...
     */
    public PermissiveBatchEmailsResponse(final List<BatchEmail> data, final List<BatchError> errors) {
        super(data);
        this.errors = errors;
    }
