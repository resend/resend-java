...
public class ContactPropertiesUtil {
    ...
    public static ListContactPropertiesResponseSuccess createContactPropertiesListResponse() {
        ...
        ContactProperty p1 = new ContactProperty("1", "age", "2023-04-08 00:11:13.110779+00", "string", "25");
        ContactProperty p2 = new ContactProperty("2", "city", "2023-04-08 00:11:13.110779+00", "string", "New York");
        ContactProperty p3 = new ContactProperty("3", "subscribed", "2023-04-08 00:11:13.110779+00", "string", "fallback");
